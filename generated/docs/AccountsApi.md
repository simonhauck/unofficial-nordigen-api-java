...
public class Example {
    public static void main(String[] args) {
        ...
        UUID id = UUID.randomUUID(); // UUID | 
        try {
            apiInstance.retrieveAccountDetails(id);
        } catch (ApiException e) {
...
> retrieveAccountTransactions(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        UUID id = UUID.randomUUID(); // UUID | 
        try {
            apiInstance.retrieveAccountTransactions(id);
        } catch (ApiException e) {
