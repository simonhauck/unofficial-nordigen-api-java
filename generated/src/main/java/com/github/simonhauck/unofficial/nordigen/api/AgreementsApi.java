...
public class AgreementsApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void retrieveEUAText(UUID id) throws RestClientException {
        retrieveEUATextWithHttpInfo(id);
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> retrieveEUATextWithHttpInfo(UUID id) throws RestClientException {
        Object postBody = null;
