...
public class EndUserAgreement {
  ...
  private JsonNullable<String> accepted = JsonNullable.<String>undefined();
  ...
  **/
  ...
  public EndUserAgreement created(String created) {
  ...
  **/
  ...
  public EndUserAgreement accepted(String accepted) {
    this.accepted = JsonNullable.<String>of(accepted);
  ...
  **/
  ...
  public JsonNullable<String> getAccepted_JsonNullable() {
    return accepted;
  }
  
  @JsonProperty(JSON_PROPERTY_ACCEPTED)
  public void setAccepted_JsonNullable(JsonNullable<String> accepted) {
